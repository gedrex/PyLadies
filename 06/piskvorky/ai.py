...
def tah_pocitace(game_table, game_table_char, pc_char, user_char, free_positions, hardness):
    """
    tah_pocitace(game_table, game_table_char, pc_char, user_char, free_positions, hardness)
    -- tah_pocitace('hraci pole', 'znk volneho hraciho pole', 'znak hrace - pc', 'znak hrace - cloveka', [volne pozice], obtiznost<'easy', 'medium', 'hard')
